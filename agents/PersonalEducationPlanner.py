...
class UploadFileTool(BaseTool):
    name = "upload file"
    description = "useful when the user asks to upload a file"
    ...
    def _run(
        ...
        """Use the tool."""
        html_template = '''
        <h1>THIS SHOULD BE SUBMIT BUTTON</h1>
        '''
...
When Assistant is asked if the user can upload a file, use the upload file Tool and return the html_template variable in the function as your final answer instead of forming your own sentence. Do not form your own sentence!
